...
(function (window, document, dragNdrop) {
    ...
    var defaultMaxWidth = window.kaytoMaxWidth || 1440;
...
(function (document) {
    ...
    function ready () {
        ...
        styleView.textContent = '.kayto{margin-left:auto;margin-right:auto;max-width:1440px;pointer-events:none}.kayto-ctrl::after,.kayto::after{clear:both;content:\' \';display:table}.kayto .kayto-container{display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;max-width:1440px;opacity:.4;position:fixed;width:100%;z-index:1100}.kayto .kayto-container>.kayto-column{background-color:#80bde1;box-sizing:border-box;-ms-flex:0 1 auto;flex:0 1 auto;float:left;height:100vh;padding-left:8px;padding-right:8px;width:8.33333%}.kayto .kayto-container>.kayto-column>.kayto-content{background-color:#409bd2;height:100vh;overflow-x:hidden}.kayto-ctrl{background-color:#474747;bottom:16px;cursor:move;font-family:"Helvetica Neue",Helvetica,"Roboto",Arial,sans-serif;font-size:16px;min-width:170px;opacity:.5;padding:16px;position:fixed;right:24px;z-index:1200}.kayto-ctrl:hover{opacity:1}.kayto-ctrl .kayto-ctrl-container label:hover,.kayto-ctrl input[type=checkbox]:hover{cursor:pointer}.kayto-ctrl input[type=checkbox]{margin-right:.5em;visibility:visible}.kayto-ctrl input[type=text]{color:#474747;width:100%}.kayto-ctrl .kayto-ctrl-current-width-panel,.kayto-ctrl .kayto-ctrl-max-width-panel,.kayto-ctrl .kayto-ctrl-max-width-panel .kayto-current-max-width-ctrl,.kayto-ctrl label{color:#fff}.kayto-ctrl .kayto-ctrl-max-width-panel .kayto-edit-icon{color:#fff;margin-left:.5em;position:relative;top:3px}.kayto-ctrl .kayto-ctrl-max-width-panel .kayto-edit-icon>svg{fill:#fff;height:16px;width:16px}';
